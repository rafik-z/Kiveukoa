  ...
  e = void 0 !== e && e.Math == Math ? e : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), F.fn.form = function (x) {
    var C,
      ...
      var n,
          ...
          h.get.settings(), P ? (p === D && h.instantiate(), h.invoke(A)) : (p !== D && p.invoke("destroy"), h.verbose("Initializing form validation", r, u), h.bindEvents(), h.set.defaults(), h.instantiate());
        }, instantiate: function instantiate() {
          ...
          h.verbose("Attaching form events"), r.on("submit" + g, h.validate.form).on("blur" + g, f.field, h.event.field.blur).on("click" + g, f.submit, h.submit).on("click" + g, f.reset, h.reset).on("click" + g, f.clear, h.clear), u.keyboardShortcuts && r.on("keydown" + g, f.field, h.event.field.keydown), n.each(function () {
            var e = F(this),
                t = e.prop("type"),
          ...
          r.off(g), n.off(g), e.off(g), n.off(g);
              ...
              var t = F(this),
                  n = t.closest(l),
                  i = h.get.validation(t);n.hasClass(m.error) ? (h.debug("Revalidating field", t, i), i && h.validate.field(i)) : "blur" == u.on && i && h.validate.field(i);
            }, change: function change(e) {
              var t = F(this),
                  n = t.closest(l),
                  i = h.get.validation(t);i && ("change" == u.on || n.hasClass(m.error) && u.revalidate) && (clearTimeout(h.timer), h.timer = setTimeout(function () {
                h.debug("Revalidating field", t, h.get.validation(t)), h.validate.field(i);
              }, u.delay));
            } } }, get: { ancillaryValue: function ancillaryValue(e) {
            return !(!e.type || !e.value && !h.is.bracketedRule(e)) && (e.value !== D ? e.value : e.type.match(u.regExp.bracket)[1] + "");
          }, ruleName: function ruleName(e) {
            return h.is.bracketedRule(e) ? e.type.replace(e.type.match(u.regExp.bracket)[0], "") : e.type;
            ...
            var n,
                ...
                l = -1 !== s.search("{value}"),
                c = -1 !== s.search("{name}");return (c || l) && (i = h.get.field(t.identifier)), l && (s = s.replace("{value}", i.val())), c && (o = 1 == (n = i.closest(f.group).find("label").eq(0)).length ? n.text() : i.prop("placeholder") || u.text.unspecifiedField, s = s.replace("{name}", o)), s = (s = s.replace("{identifier}", t.identifier)).replace("{ruleValue}", r), e.prompt || h.verbose("Using default validation prompt for type", s, a), s;
          }, settings: function settings() {
            if (F.isPlainObject(x)) {
              var e = Object.keys(x);0 < e.length && x[e[0]].identifier !== D && x[e[0]].rules !== D ? (u = F.extend(!0, {}, F.fn.form.settings, R), c = F.extend({}, F.fn.form.settings.defaults, x), h.error(u.error.oldSyntax, v), h.verbose("Extending settings from legacy parameters", c, u)) : (x.fields && h.is.shorthandFields(x.fields) && (x.fields = h.get.fieldsFromShorthand(x.fields)), u = F.extend(!0, {}, F.fn.form.settings, x), c = F.extend({}, F.fn.form.settings.defaults, u.fields), h.verbose("Extending settings", c, u));
            } else u = F.fn.form.settings, c = F.fn.form.settings.defaults, h.verbose("Using default form validation", c, u);o = u.namespace, d = u.metadata, f = u.selector, m = u.className, i = u.regExp, s = u.error, a = "module-" + o, g = "." + o, p = r.data(a), h.refresh();
          }, field: function field(e) {
            return h.verbose("Finding field with identifier", e), e = h.escape.string(e), 0 < n.filter("#" + e).length ? n.filter("#" + e) : 0 < n.filter('[name="' + e + '"]').length ? n.filter('[name="' + e + '"]') : 0 < n.filter('[name="' + e + '[]"]').length ? n.filter('[name="' + e + '[]"]') : 0 < n.filter("[data-" + d.validate + '="' + e + '"]').length ? n.filter("[data-" + d.validate + '="' + e + '"]') : F("<input/>");
            ...
            return h.verbose("Checking for existence of a field with identifier", e), "string" != typeof (e = h.escape.string(e)) && h.error(s.identifier, e), 0 < n.filter("#" + e).length || 0 < n.filter('[name="' + e + '"]').length || 0 < n.filter("[data-" + d.validate + '="' + e + '"]').length;
            ...
            h.debug("Adding form error messages", e), h.set.error(), t.html(u.templates.error(e));
            ...
            var t = h.get.field(e).closest(l),
                n = t.children(f.prompt);t.removeClass(m.error), u.inline && n.is(":visible") && (h.verbose("Removing prompt for field", e), u.transition && F.fn.transition !== D && r.transition("is supported") ? n.transition(u.transition + " out", u.duration, function () {
              n.remove();
            ...
            n.each(function () {
              var e = F(this),
                  t = 0 < e.filter(f.checkbox).length ? e.is(":checked") : e.val();e.data(d.defaultValue, t);
            });
          }, error: function error() {
            ...
            var n = h.get.values();if (y) return !1;if (b = [], h.determine.isValid()) {
              if (h.debug("Form has no validation errors, submitting"), h.set.success(), !0 !== t) return u.onSuccess.call(v, e, n);
            } else if (h.debug("Form has errors"), h.set.error(), u.inline || h.add.errors(b), r.data("moduleApi") !== D && e.stopImmediatePropagation(), !0 !== t) return u.onFailure.call(v, b, n);
            ...
            }), r ? (t && (h.remove.prompt(i, s), u.onValid.call(o)), !0) : (t && (b = b.concat(s), h.add.prompt(i, s), u.onInvalid.call(o, s)), !1);
          }, rule: function rule(e, t) {
            var n = h.get.field(e.identifier),
                i = (t.type, n.val()),
                o = h.get.ancillaryValue(t),
                a = h.get.ruleName(t),
                r = u.rules[a];if (F.isFunction(r)) return i = i === D || "" === i || null === i ? "" : F.trim(i + ""), r.call(n, i, o);h.error(s.noRule, a);
          } }, setting: function setting(e, t) {
          if (F.isPlainObject(e)) F.extend(!0, u, e);else {
            if (t === D) return u[e];u[e] = t;
          }
        }, internal: function internal(e, t) {
          ...
          !u.silent && u.debug && (u.performance ? h.performance.log(arguments) : (h.debug = Function.prototype.bind.call(console.info, console, u.name + ":"), h.debug.apply(console, arguments)));
        }, verbose: function verbose() {
          !u.silent && u.verbose && u.debug && (u.performance ? h.performance.log(arguments) : (h.verbose = Function.prototype.bind.call(console.info, console, u.name + ":"), h.verbose.apply(console, arguments)));
        }, error: function error() {
          u.silent || (h.error = Function.prototype.bind.call(console.error, console, u.name + ":"), h.error.apply(console, arguments));
        }, performance: { log: function log(e) {
            var t, n;u.performance && (n = (t = new Date().getTime()) - (k || t), k = t, T.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: v, "Execution Time": n })), clearTimeout(h.performance.timer), h.performance.timer = setTimeout(h.performance.display, 500);
          }, display: function display() {
            var e = u.name + ":",
    ...
    var L,
      ...
      var e,
          ...
          var e = O.not(h.filtered).filter("." + h.selected).eq(0),
            ...
            if (t = t !== J ? t : e, g.can.activate(Y(n))) {
              if (g.set.value(t, Y(n)), g.is.multiple() && !g.is.allFiltered()) return;g.hideAndClear();
            }
          ...
          var n,
            ...
            var i,
                ...
                a = g.escape.value(e);i = Y("<a />").addClass(h.label).attr("data-" + b.value, a).html(m.label(a, t)), i = p.onLabelCreate.call(i, a, t), g.has.value(e) ? g.debug("User selection already exists, skipping", a) : (p.label.variation && i.addClass(p.label.variation), !0 === n ? (g.debug("Animating in label", i), i.addClass(h.hidden).insertBefore(o).transition(p.label.transition, p.label.duration)) : (g.debug("Adding selection label", i), i.insertBefore(o)));
            ...
            var t = g.escape.value(e);return 0 < w.find(y.label).filter("[data-" + b.value + '="' + g.escape.string(t) + '"]').length;
            ...
            var e = g.get.values(),
              ...
              if (String(n).toLowerCase() == String(t).toLowerCase()) return i = !0, !1;
            }), i;
          } }, is: { active: function active() {
      ...
      var f,
          ...
          e = E.isFunction(e) ? e : function () {};var t = f.get.value(),
            ...
            var o = [],
                ...
                s = new RegExp(d.beginsWith + n, "i"),
                l = function l(e, t) {
              var n = -1 == E.inArray(t, o),
                  i = -1 == E.inArray(t, r);n && i && e.push(t);
            };return t = t || c.source, e = e !== D ? e : c.searchFields, E.isArray(e) || (e = [e]), t === D || !1 === t ? (f.error(p.source), []) : (E.each(e, function (e, n) {
              E.each(t, function (e, t) {
                "string" == typeof t[n] && (-1 !== t[n].search(s) ? l(o, t) : "exact" === c.fullTextSearch && f.exactSearch(i, t[n]) ? l(a, t) : 1 == c.fullTextSearch && f.fuzzySearch(i, t[n]) && l(r, t));
              });
  ...
  e = void 0 !== e && e.Math == Math ? e : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), w.fn.state = function (m) {
    var g,
      ...
      var s,
          ...
          u = w(this),
          d = this,
          f = u.data(c);s = { initialize: function initialize() {
          ...
          s.allows(e) && u.removeClass(t[e]);
            ...
            var e;if (s.allows("active") && s.is.enabled()) {
              if (s.refresh(), w.fn.api !== S) if (e = u.api("get request"), u.api("was cancelled")) s.debug("API Request cancelled by beforesend"), o.activateTest = function () {
                return !1;
              }, o.deactivateTest = function () {
                return !1;
              };else if (e) return void s.listenTo(e);s.change.state();
            }
          ...
          s.verbose("Syncing other buttons to current state"), s.is.active() ? p.not(u).state("activate") : p.not(u).state("deactivate");
            ...
            var i = s.get.text();s.debug("Flashing text message", e, t), e = e || o.text.flash, t = t || o.flashDuration, n = n || function () {}, s.update.text(e), setTimeout(function () {
              s.update.text(i), n.call(d);
            }, t);
          } }, reset: { text: function text() {
            var e = a.active || u.data(n.storedText),
                t = a.inactive || u.data(n.storedText);s.is.textEnabled() && (s.is.active() && e ? (s.verbose("Resetting active text", e), s.update.text(e)) : t && (s.verbose("Resetting inactive text", e), s.update.text(t)));
          } }, update: { text: function text(e) {
            var t = s.get.text();e && e !== t ? (s.debug("Updating text", e), o.selector.text ? u.data(n.storedText, e).find(o.selector.text).text(e) : u.data(n.storedText, e).html(e)) : s.debug("Text is already set, ignoring update", e);
          } }, setting: function setting(e, t) {
          ...
          o.silent || (s.error = Function.prototype.bind.call(console.error, console, o.name + ":"), s.error.apply(console, arguments));
            ...
            var t, n;o.performance && (n = (t = new Date().getTime()) - (v || t), v = t, b.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: d, "Execution Time": n })), clearTimeout(s.performance.timer), s.performance.timer = setTimeout(s.performance.display, 500);
          }, display: function display() {
            var e = o.name + ":",
                n = 0;v = !1, clearTimeout(s.performance.timer), w.each(b, function (e, t) {
              n += t["Execution Time"];
          ...
          var o,
              a,
              n,
              r = f;return e = e || C, t = d || t, "string" == typeof i && r !== S && (i = i.split(/[\. ]/), o = i.length - 1, w.each(i, function (e, t) {
            var n = e != o ? t + i[e + 1].charAt(0).toUpperCase() + i[e + 1].slice(1) : i;if (w.isPlainObject(r[n]) && e != o) r = r[n];else {
              if (r[n] !== S) return a = r[n], !1;if (!w.isPlainObject(r[t]) || e == o) return r[t] !== S ? a = r[t] : s.error(l.method, i), !1;r = r[t];
            }
          })), w.isFunction(a) ? n = a.apply(t, e) : a !== S && (n = a), w.isArray(g) ? g.push(n) : g !== S ? g = [g, n] : n !== S && (g = n), a;
        ...
        setTimeout(e, 0);
          ...
          var n = s.get.elementCalculations(),
            ...
            var e = s.get.screenCalculations(),
                t = s.get.elementPosition();return o.includeMargin ? (t.margin = {}, t.margin.top = parseInt(f.css("margin-top"), 10), t.margin.bottom = parseInt(f.css("margin-bottom"), 10), t.top = t.offset.top - t.margin.top, t.bottom = t.offset.top + t.height + t.margin.bottom) : (t.top = t.offset.top, t.bottom = t.offset.top + t.height), t.topPassed = e.top >= t.top, t.bottomPassed = e.top >= t.bottom, t.topVisible = e.bottom >= t.top && !t.topPassed, t.bottomVisible = e.bottom >= t.bottom && !t.bottomPassed, t.pixelsPassed = 0, t.percentagePassed = 0, t.onScreen = t.topVisible && !t.bottomPassed, t.passing = t.topPassed && !t.bottomPassed, t.offScreen = !t.onScreen, t.passing && (t.pixelsPassed = e.top - t.top, t.percentagePassed = (e.top - t.top) / t.height), s.cache.element = t, s.verbose("Updated element calculations", t), t;
